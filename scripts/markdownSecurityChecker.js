...
export class MarkdownSecurityChecker {
     ...
     */
    static generateFileReport(result) {
     ...
     */
    static groupFindingsByType(findings) {
     ...
     */
    static generateTypeSection(type, findings) {
     ...
     */
    static generateFindingRow(finding) {
